...
def register_dataset(root):
    ...
    # Note: Only val dataset there
    for split, image_dirname, sem_seg_dirname, class_names in [
        ('train', 'images_detectron2/val', 'annotations_detectron2/val', CLASSES),
        ('val', 'images_detectron2/val', 'annotations_detectron2/val', CLASSES_OFFICIAL),
    ]:
